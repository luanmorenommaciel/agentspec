---
name: agent-router
description: Intelligent agent routing -- automatically matches tasks to the best specialist agent based on file patterns, intent keywords, and domain context. Loaded every session to give Claude explicit routing rules for all 116 AgentSpec agents.
---
...
**Agent count:** 116  |  **Categories:** 8  |  **Content hash:** `8af631f5905c`
...
| KB Domain | Agents |
|-----------|--------|
| `ai-data-engineering` | `ai-data-engineer`, `ai-data-engineer`, `genai-architect`, `genai-architect`, `qdrant-specialist`, `qdrant-specialist`, `supabase-specialist`, `supabase-specialist` |
| `airflow` | `airflow-specialist`, `airflow-specialist`, `pipeline-architect`, `pipeline-architect` |
| `aws` | `ai-data-engineer-cloud`, `ai-data-engineer-cloud`, `aws-data-architect`, `aws-data-architect`, `aws-deployer`, `aws-deployer`, `aws-lambda-architect`, `aws-lambda-architect`, `ci-cd-specialist`, `ci-cd-specialist`, `lambda-builder`, `lambda-builder` |
| `cloud-platforms` | `ai-data-engineer-cloud`, `ai-data-engineer-cloud`, `ai-data-engineer-gcp`, `ai-data-engineer-gcp`, `data-platform-engineer`, `data-platform-engineer`, `gcp-data-architect`, `gcp-data-architect`, `spark-performance-analyzer`, `spark-performance-analyzer`, `spark-specialist`, `spark-specialist` |
| `data-modeling` | `data-contracts-engineer`, `data-contracts-engineer`, `data-platform-engineer`, `data-platform-engineer`, `data-quality-analyst`, `data-quality-analyst`, `lakehouse-architect`, `lakehouse-architect`, `medallion-architect`, `medallion-architect`, `schema-designer`, `schema-designer`, `sql-optimizer`, `sql-optimizer`, `supabase-specialist`, `supabase-specialist` |
| `data-quality` | `ai-data-engineer`, `ai-data-engineer`, `ai-data-engineer-cloud`, `ai-data-engineer-cloud`, `ai-data-engineer-gcp`, `ai-data-engineer-gcp`, `airflow-specialist`, `airflow-specialist`, `aws-data-architect`, `aws-data-architect`, `code-reviewer`, `code-reviewer`, `data-contracts-engineer`, `data-contracts-engineer`, `data-quality-analyst`, `data-quality-analyst`, `dbt-specialist`, `dbt-specialist`, `gcp-data-architect`, `gcp-data-architect`, `lakeflow-expert`, `lakeflow-expert`, `lakeflow-pipeline-builder`, `lakeflow-pipeline-builder`, `lakeflow-specialist`, `lakeflow-specialist`, `medallion-architect`, `medallion-architect`, `pipeline-architect`, `pipeline-architect`, `schema-designer`, `schema-designer`, `test-generator`, `test-generator` |
| `dbt` | `code-reviewer`, `code-reviewer`, `data-quality-analyst`, `data-quality-analyst`, `dbt-specialist`, `dbt-specialist`, `pipeline-architect`, `pipeline-architect`, `sql-optimizer`, `sql-optimizer`, `test-generator`, `test-generator` |
| `gcp` | `ai-data-engineer-cloud`, `ai-data-engineer-cloud`, `ai-data-engineer-gcp`, `ai-data-engineer-gcp`, `ai-prompt-specialist-gcp`, `ai-prompt-specialist-gcp`, `gcp-data-architect`, `gcp-data-architect` |
| `genai` | `ai-prompt-specialist`, `ai-prompt-specialist`, `ai-prompt-specialist-gcp`, `ai-prompt-specialist-gcp`, `genai-architect`, `genai-architect`, `llm-specialist`, `llm-specialist`, `qdrant-specialist`, `qdrant-specialist` |
| `lakeflow` | `ci-cd-specialist`, `ci-cd-specialist`, `lakeflow-architect`, `lakeflow-architect`, `lakeflow-expert`, `lakeflow-expert`, `lakeflow-pipeline-builder`, `lakeflow-pipeline-builder`, `lakeflow-specialist`, `lakeflow-specialist` |
| `lakehouse` | `data-platform-engineer`, `data-platform-engineer`, `lakeflow-architect`, `lakeflow-architect`, `lakeflow-expert`, `lakeflow-expert`, `lakeflow-pipeline-builder`, `lakeflow-pipeline-builder`, `lakeflow-specialist`, `lakeflow-specialist`, `lakehouse-architect`, `lakehouse-architect`, `medallion-architect`, `medallion-architect`, `spark-performance-analyzer`, `spark-performance-analyzer`, `spark-streaming-architect`, `spark-streaming-architect` |
| `medallion` | `lakeflow-architect`, `lakeflow-architect`, `lakeflow-expert`, `lakeflow-expert`, `lakeflow-pipeline-builder`, `lakeflow-pipeline-builder`, `medallion-architect`, `medallion-architect` |
| `microsoft-fabric` | `fabric-ai-specialist`, `fabric-ai-specialist`, `fabric-architect`, `fabric-architect`, `fabric-cicd-specialist`, `fabric-cicd-specialist`, `fabric-logging-specialist`, `fabric-logging-specialist`, `fabric-pipeline-developer`, `fabric-pipeline-developer`, `fabric-security-specialist`, `fabric-security-specialist` |
| `prompt-engineering` | `ai-prompt-specialist`, `ai-prompt-specialist`, `ai-prompt-specialist-gcp`, `ai-prompt-specialist-gcp`, `genai-architect`, `genai-architect`, `llm-specialist`, `llm-specialist` |
| `pydantic` | `ai-prompt-specialist`, `ai-prompt-specialist`, `ai-prompt-specialist-gcp`, `ai-prompt-specialist-gcp`, `llm-specialist`, `llm-specialist`, `python-developer`, `python-developer` |
| `python` | `code-cleaner`, `code-cleaner`, `code-documenter`, `code-documenter`, `lambda-builder`, `lambda-builder`, `prompt-crafter`, `prompt-crafter`, `python-developer`, `python-developer` |
| `spark` | `lakeflow-architect`, `lakeflow-architect`, `lakeflow-specialist`, `lakeflow-specialist`, `lakehouse-architect`, `lakehouse-architect`, `spark-engineer`, `spark-engineer`, `spark-performance-analyzer`, `spark-performance-analyzer`, `spark-specialist`, `spark-specialist`, `spark-streaming-architect`, `spark-streaming-architect`, `spark-troubleshooter`, `spark-troubleshooter`, `streaming-engineer`, `streaming-engineer` |
| `sql-patterns` | `airflow-specialist`, `airflow-specialist`, `code-reviewer`, `code-reviewer`, `dbt-specialist`, `dbt-specialist`, `schema-designer`, `schema-designer`, `spark-engineer`, `spark-engineer`, `spark-specialist`, `spark-specialist`, `spark-troubleshooter`, `spark-troubleshooter`, `sql-optimizer`, `sql-optimizer`, `streaming-engineer`, `streaming-engineer` |
| `streaming` | `ai-data-engineer`, `ai-data-engineer`, `spark-engineer`, `spark-engineer`, `spark-streaming-architect`, `spark-streaming-architect`, `streaming-engineer`, `streaming-engineer` |
| `supabase` | `supabase-specialist`, `supabase-specialist` |
| `terraform` | `ai-data-engineer-cloud`, `ai-data-engineer-cloud`, `ai-data-engineer-gcp`, `ai-data-engineer-gcp`, `aws-data-architect`, `aws-data-architect`, `aws-deployer`, `aws-deployer`, `aws-lambda-architect`, `aws-lambda-architect`, `ci-cd-specialist`, `ci-cd-specialist`, `gcp-data-architect`, `gcp-data-architect` |
| `testing` | `lambda-builder`, `lambda-builder`, `python-developer`, `python-developer`, `test-generator`, `test-generator` |
## C. Agent One-Liners
