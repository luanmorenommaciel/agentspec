...
**What is AgentSpec?** A Claude Code plugin that provides structured AI-assisted development through a 5-phase SDD workflow, specialized for data engineering with 58 agents, 31 commands, 24 KB domains, and 12 skills (10 distributed in the plugin + 2 repo-local).
...
│   ├── skills/              # 10 skills (8 from .claude/ + 2 plugin-only; repo-local excluded)
