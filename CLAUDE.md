...
**Current Status:** v3.5.1 shipped (single-source `plugin.json` version, bump gate extended to documentation surfaces, branching/versioning doctrine in CONTRIBUTING.md and `docs/reference/releasing.md`). Linear is the project tracker (source of truth).
