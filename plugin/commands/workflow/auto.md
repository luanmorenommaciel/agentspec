...
1. **Load `${CLAUDE_PLUGIN_ROOT}/skills/sdd-autopilot/SKILL.md`** and follow it end to end: intake (feature name derivation, resume matching), RUN REPORT creation, branch-first setup, the phase loop with Gates 0/L/J/B/S/PR, checkpoint commits, terminal status, notification.
